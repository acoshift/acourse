<template lang="pug">
  div
    ...
    h4 What personal information do we collect from the people that visit our blog, website or app?
    p When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, phone number or other details to help you with your experience.
    ...
    p If you turn cookies off, some features will be disabled. It won't affect the user's experience that make your site experience more efficient and may not function properly.
    ...
    h4 We have implemented the following:
    p
      ul
    ...
    p acourse.io
      ...
      | 400/107 Lardyao
      br
      | Bangkok, Jatujak 10900
      br
      | contact@acourse.io
    p Last Edited on 2017-01-04
</template>
