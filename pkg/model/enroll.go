...
func Enroll(ctx context.Context, db DB, userID string, courseID int64) error {
...
func IsEnrolled(ctx context.Context, db DB, userID string, courseID int64) (bool, error) {
	var p int
